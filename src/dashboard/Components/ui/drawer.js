...
const DrawerOverlay = React.forwardRef(({ className, ...props }, ref) => (
  <DrawerPrimitive.Overlay ref={ref} className={classnames("fixed inset-0 z-50 bg-black/80", className)} {...props} />
));
...
const DrawerDescription = React.forwardRef(({ className, ...props }, ref) => (
  <DrawerPrimitive.Description ref={ref} className={classnames("text-sm text-muted-foreground", className)} {...props} />
));
