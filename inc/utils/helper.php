...
use Matriq\MSA\Core\Models\Controller;
...
class Helper {
	...
	public static function update_option( $key, $value = true ) {
		$portal_settings = Settings::get_settings( false );
		...
		update_option( MATRIQ_MSA_SETTINGS, $portal_settings );
	...
	public static function delete_option( $key ) {
		$portal_settings = get_option( MATRIQ_MSA_SETTINGS );
